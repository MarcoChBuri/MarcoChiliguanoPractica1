...
public class ListArray<E> {
    ...
    public ListArray() {
        this.capacity = 10; // Un valor predeterminado para la capacidad
    ...
    public void add(E element, Integer index) throws ListArrayException {
        if (index >= 0 && index <= this.size) {
            ...
            throw new ListArrayException("El indice está fuera de rango");
        }
    }
    ...
    private void resize() {
        capacity *= 2; // Duplicar la capacidad para un mejor rendimiento
